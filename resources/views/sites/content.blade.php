        ...
        <div class="info">
            ...
            <div class="info-tabcontent fade">
                <div class="description">
                    ...
                    <div class="description-text">Йога, массажи и плавание в море - помогут уставшей спине! Индийские
                ...
                <div class="photo">
                    <img src="{{asset('assets/img/massage.jpg')}}" alt="Massage">
                </div>
            </div>
            <div class="info-tabcontent fade">
                <div class="description">
                ...
                <div class="photo">
                    <img src="{{asset('assets/img/sunset.jpg')}}" alt="sunset">
                </div>
            </div>
            <div class="info-tabcontent fade">
                <div class="description">
                ...
                <div class="photo">
                    <img src="{{asset('assets/img/sunrise.jpg')}}" alt="sunrise">
                </div>
            </div>
            <div class="info-tabcontent fade">
                <div class="description">
                ...
                <div class="photo">
                    <img src="{{asset('assets/img/yoga.jpg')}}" alt="yoga">
                </div>
            </div>
        </div>
        <div class="timer">
